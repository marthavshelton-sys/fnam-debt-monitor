...
(function () {
  ...
  const S = {
    ...
    cmtNote: { es: 'Comentarios (a/a) elaborados a partir de la discusión de la administración en los informes trimestrales. Las citas (💬) provienen de las transcripciones de las conferencias de resultados suministradas a mano (FactSet CallStreet 3T23–4T25, Bloomberg 1T26–2T26; original en inglés, traducción al español propia).', en: 'Comments (y/y) written from the management discussion in the quarterly releases. Quotes (💬) come from the hand-supplied earnings-call transcripts (FactSet CallStreet 3Q23–4Q25, Bloomberg 1Q26–2Q26; English original, Spanish translation ours).' },
  ...
  function renderGuidance() {
    ...
    html('guideCurSrc', `${t('src')}: <a href="${cur.source.url}" target="_blank" rel="noopener">${L(cur.source.title)} ↗</a> · ${LANG === 'es' ? 'Cifras de año completo; crecimiento sobre el año fiscal anterior; etapa 3 y costo de riesgo como niveles anuales; UPA sobre la utilidad controladora y 1,579.2 M de acciones; ROE = ROE controlador como lo reporta Gentera.' : (GD.basis || '')}`);
