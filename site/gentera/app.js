...
(function () {
  ...
  function renderMonthly() {
    ...
    el('monthlyCap').textContent = es ? 'Últimos 12 meses publicados por cada regulador, en millones de la moneda local. CNBV: cartera total, IMOR y cobertura del Boletín Estadístico (captación total = depósitos + préstamos interbancarios + títulos). SBS: cartera directa (vigente + refinanciada + atrasada), morosidad, cartera neta, utilidad acumulada y patrimonio de los cuadros B-2201 y B-2362; Compartamos Banco figura en Banca Múltiple desde 2025.' : 'Last 12 months published by each regulator, in millions of local currency. CNBV: total loans, IMOR and coverage from the statistical bulletin (total funding = deposits + interbank loans + securities). SBS: direct loans (performing + refinanced + overdue), delinquency, net loans, year-to-date income and equity from tables B-2201 and B-2362; Compartamos Banco appears under Banca Múltiple from 2025.';
