...
window.G_REF = {
  ...
  dividendPolicy: { pct: 40, proposed: 45, note: { es: "Política vigente: 40% de la utilidad neta controladora del año anterior. La propuesta de subir la distribución hasta 45% no alcanzó los votos necesarios en la asamblea del 10 de abril de 2026; según el director general (conferencia del 23 de abril), la empresa no la comunicó lo suficiente. El consejo convocó una asamblea extraordinaria para junio; el 23 de julio la administración dijo que la propondrá de nuevo en 2027. Supuesto: junio no la adoptó (resultado no informado).", en: "Current policy: 40% of the prior year's controlling net income. The proposal to lift the distribution to up to 45% fell short of the required votes at the 10 April 2026 AGM; per the CEO (23 April call) the company had 'not communicated' it enough. The board called an extraordinary meeting for June; on 23 July management said it will re-propose it in 2027. Assumption: June did not adopt it (outcome not reported)." } },
  dividends: [
