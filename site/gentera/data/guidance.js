...
// transcripts of the calls (hand-supplied, FactSet CallStreet 3T23–4T25, Bloomberg 1T26–2T26) and the releases.
window.G_GUIDANCE = {
  ...
  vintages: [
    ...
    {
      fy: 2026, kind: "reaffirmed", date: "2026-04-22", quarter: "2026Q1", call: "2026-04-23",
      source: { url: "https://www.gentera.com.mx/gentera/relacion-inversionistas/informacion_trimestral", date: "2026-04-22", title: { es: "Informe 1T26 y conferencia del 23 de abril de 2026", en: "1Q26 release and call of 23 April 2026" }, transcript: "tools/gentera/raw/text/transcripts/2026Q1-transcript-Gentera_1T26_earnings_call_transcript_2026-04-23.txt" },
      items: {
        eps: { lo: 5.88, hi: 6.03, text: { es: "Reiterada: Ps. 5.88–6.03; \"esperamos cumplir la guía y las metas de crecimiento de 2026\".", en: "Reaffirmed: Ps. 5.88–6.03; \"we expect to deliver on our guidance and growth targets for 2026\"." } },
        loanGrowth: { lo: 13, hi: 16, text: { es: "Reiterada 13%–16% (+14.7% en el 1T26); sin cambio en la mezcla por producto.", en: "Reaffirmed 13%–16% (+14.7% at 1Q26); no change in the product mix." } },
        opexGrowth: { lo: 12, hi: 13, text: { es: "Mantenida en 12%–13% (+10.5% en el 1T26).", en: "Kept at 12%–13% (+10.5% in 1Q26)." } },
        cor: { lo: 13, hi: 13.5, text: { es: "Ahora \"más cerca del techo\" del rango normal de 13%–13.5% (12.9% en el 1T26) por la etapa 3 del crédito individual en México.", en: "Now \"closer to the high end\" of the normal 13%–13.5% range (12.9% in 1Q26) on individual-loan stage 3 in Mexico." } },
        npl: { lo: 3.5, hi: 4.5, text: { es: "Alrededor de 4% (4.13% en el 1T26; Banco 4.86%); normalización del individual hacia fin de año.", en: "Around 4% (4.13% at 1Q26; Bank 4.86%); individual loans to normalise by year-end." } },
        roe: { lo: 25, hi: 25, text: { es: "Alrededor de 25% (26.5% en el 1T26, el mejor trimestre desde 2017).", en: "Around 25% (26.5% in 1Q26, the best quarter since 2017)." } },
      },
      notes: { es: ["MIN ~41% y MIN después de provisiones ~30% al cierre; comisiones netas convergiendo al crecimiento de clientes (~12%); cobertura de regreso a 210%–220%; sin efectos adicionales de impuestos diferidos; reserva de Ps. 500 M por contingencias sin cambio.", "Asamblea del 10 de abril de 2026: dividendo de 40% de la utilidad controladora 2025 (≈Ps. 3,285.9 M) en dos pagos (23 de abril y a más tardar 27 de noviembre); las propuestas de subir el pago hasta 45% y la contribución a Fundación Compartamos hasta 3% no alcanzaron los votos necesarios y el consejo convocó una asamblea extraordinaria para junio.", "Consejo: salen Antonio Rallo Verdugo (11 años) y Juan Carlos Torres Cisneros (cofundador de ConCrédito); Silvia Tapia Navarro y Santiago Casanueva Pérez se incorporan al consejo de Compartamos Banco Perú."], en: ["NIM ~41% and NIM after provisions ~30% at year-end; net fees converging to client growth (~12%); coverage back to 210%–220%; no further deferred-tax effects; the Ps. 500 M contingency reserve unchanged.", "AGM of 10 April 2026: 40% of 2025 controlling net income (≈Ps. 3,285.9 M) in two instalments (23 April and by 27 November); the proposals to lift the payout to up to 45% and the Fundación Compartamos contribution to up to 3% did not obtain the required votes and the board called an extraordinary meeting for June.", "Board: Antonio Rallo Verdugo (11 years) and Juan Carlos Torres Cisneros (ConCrédito co-founder) step down; Silvia Tapia Navarro and Santiago Casanueva Pérez join the board of Compartamos Banco Perú."] },
    },
    {
      fy: 2026, kind: "revised", date: "2026-07-22", quarter: "2026Q2", call: "2026-07-23",
      source: { url: "https://www.gentera.com.mx/gentera/relacion-inversionistas/informacion_trimestral", date: "2026-07-22", title: { es: "Informe 2T26 y conferencia del 23 de julio de 2026", en: "2Q26 release and call of 23 July 2026" }, transcript: "tools/gentera/raw/text/transcripts/2026Q2-transcript-Gentera_2T26_earnings_call_transcript_2026-07-23.txt" },
      items: {
        eps: { lo: 5.88, hi: 6.03, text: { es: "Mantenida: Ps. 5.88–6.03 (+13% a +16%); 1S26: Ps. 2.98. Se sostiene con las demás subsidiarias, las eficiencias y la disciplina de gastos.", en: "Kept: Ps. 5.88–6.03 (+13% to +16%); 1H26: Ps. 2.98. Held up by the other subsidiaries, efficiencies and expense discipline." } },
        loanGrowth: { lo: 6, hi: 9, text: { es: "Recortada a 6%–9% (cierre contra cierre) desde 13%–16%: desaceleración del consumo en México y estabilización de la calidad del crédito individual; Banco México a un dígito, Perú y ConCrédito a doble dígito; cartera promedio del año ~+10%.", en: "Cut to 6%–9% (year-end to year-end) from 13%–16%: Mexican consumer slowdown and stabilisation of individual-loan quality; Bank Mexico single digits, Perú and ConCrédito double digits; average book for the year ~+10%." } },
        opexGrowth: { lo: 10, hi: 10, text: { es: "Alrededor de +10% (desde 12%–13%); +7.7% en el 2T26 y +9.0% en el 1S26; eficiencia por debajo de 60% en un par de años.", en: "Around +10% (from 12%–13%); +7.7% in 2Q26 and +9.0% in 1H26; efficiency ratio below 60% in a couple of years." } },
        cor: { lo: 13.5, hi: 13.5, text: { es: "Alrededor de 13.5% en el año (13.7% en el 1S26; 14.5% en el 2T26); normalización en dos trimestres por el rezago del individual.", en: "Around 13.5% for the year (13.7% in 1H26; 14.5% in 2Q26); normalisation within two quarters given the individual-loan lag." } },
        npl: { lo: 3.5, hi: 4.5, text: { es: "Alrededor de 4%, \"quizá un poco más\" (4.04% en el 2T26; individual del Banco 6.5%).", en: "Around 4%, \"maybe a little higher\" (4.04% at 2Q26; Bank individual loans 6.5%)." } },
        roe: { lo: 24, hi: 25, text: { es: "ROE controlador 24%–25% (24.5% en el 2T26); 23%–24% con doble dígito en cartera y utilidad a mediano plazo.", en: "Controlling ROE 24%–25% (24.5% in 2Q26); 23%–24% with double-digit loan and earnings growth over the medium term." } },
      },
      notes: { es: ["MIN ~41% y MIN después de provisiones 29%–30% al cierre; margen financiero creciendo ~10% como la cartera promedio; castigos altos pero estables en los próximos trimestres.", "Crédito individual en México: Ps. 19 mil M (cinco veces la cartera de 2021), ~40% de participación, etapa 3 6.5% (picos previos 7.9% en 2011–12 y 5.8% en 2014–16); grupal +17% en el 1S26. Perú: ROE sostenible 20%–23%; provisiones voluntarias por El Niño. Plataforma digital del crédito grupal en México con despliegue nacional en 2027.", "Dividendo: la propuesta de elevar el pago a 45% se presentará de nuevo a la asamblea del próximo año; la política vigente sigue en 40%."], en: ["NIM ~41% and NIM after provisions 29%–30% at year-end; net interest income growing ~10% with the average book; write-offs high but stable over the next quarters.", "Mexico individual loans: Ps. 19 bn (five times the 2021 book), ~40% share, stage 3 6.5% (earlier peaks 7.9% in 2011–12 and 5.8% in 2014–16); group loans +17% in 1H26. Perú: sustainable ROE 20%–23%; voluntary provisions for El Niño. Group-lending digital platform in Mexico to reach nationwide deployment in 2027.", "Dividend: the proposal to lift the payout to 45% will be presented again at next year's meeting; the policy in force stays at 40%."] },
    },
  ],
};
