...
window.ASUR_REF = {
  ...
  concessions: [
    { scope: "9 Mexican airports", scopeEs: "9 aeropuertos en México", granted: "1998", expires: "2048", years: 50, note: { en: "50-year concessions granted by the Mexican federal government in 1998 (SICT/AFAC), extendable at the government's discretion; the term is stated in the Form 20-F, not in the archived releases.", es: "Concesiones a 50 años otorgadas por el gobierno federal en 1998 (SICT/AFAC), prorrogables a discreción del gobierno; el plazo consta en la Forma 20-F, no en los comunicados archivados." }, source: { en: "ASUR Form 20-F", es: "Forma 20-F de ASUR" } },
    { scope: "San Juan, Puerto Rico (Aerostar, 60%)", scopeEs: "San Juan, Puerto Rico (Aerostar, 60%)", granted: "2013", expires: "2053", years: 40, note: { en: "40-year lease of Luis Muñoz Marín airport under the FAA airport privatisation pilot programme (term per the Form 20-F); ASUR holds 60% of Aerostar Airport Holdings.", es: "Arrendamiento a 40 años del aeropuerto Luis Muñoz Marín bajo el programa piloto de privatización de la FAA (plazo según la Forma 20-F); ASUR tiene 60% de Aerostar Airport Holdings." }, source: { en: "ASUR releases (About ASUR) and Form 20-F", es: "Comunicados de ASUR (Acerca de ASUR) y Forma 20-F" } },
  ...
  dividends: [
    { agmYear: 2024, agmDate: "2024-04-24", dps: 20.926, note: { en: "Ps. 10.926 ordinary (May-2024) plus Ps. 10.00 extraordinary (June-2024).", es: "Ps. 10.926 ordinario (may-2024) más Ps. 10.00 extraordinario (jun-2024)." }, source: { en: "ASUR release 24-Apr-2024 (AGM resolutions)", es: "Comunicado de ASUR 24-abr-2024 (resoluciones de la asamblea)" } },
  ...
  debt: {
    ratings: [],
    instruments: [
      { name: "Aerostar 2013 bonds (US$350 M)", type: { en: "USD bond (Puerto Rico)", es: "bono en US$ (Puerto Rico)" }, issued: "2013-03", matures: "2035", principalMxn: 4262, rate: "5.75% (US$)", note: { en: "Balance US$244.0 M at 30-Jun-2026, amortising to 2035; converted at Ps. 17.4693/US$.", es: "Saldo US$244.0 M al 30-jun-2026, amortizable hasta 2035; convertido a Ps. 17.4693/US$." }, source: "ASUR 2Q26 Table 7" },
      { name: "Aerostar 2015 bonds (US$200 M)", type: { en: "USD bond (Puerto Rico)", es: "bono en US$ (Puerto Rico)" }, issued: "2015-06", matures: "2035", principalMxn: 3494, rate: "4.92% (US$)", note: { en: "Bullet 2035 (maturity modified in May-2022); Ps. 17.4693/US$.", es: "Pago único en 2035 (vencimiento modificado en may-2022); Ps. 17.4693/US$." }, source: "ASUR 2Q26 Table 7" },
      { name: "Aerostar bonds (US$50 M)", type: { en: "USD bond (Puerto Rico)", es: "bono en US$ (Puerto Rico)" }, issued: "2015-06", matures: "2035", principalMxn: 873, rate: "6.75% (US$)", note: { en: "Balance US$42.0 M; Ps. 17.4693/US$.", es: "Saldo US$42.0 M; Ps. 17.4693/US$." }, source: "ASUR 2Q26 Table 7" },
      { name: "BBVA loan (Cancún Airport)", type: { en: "bank loan", es: "préstamo bancario" }, issued: "2021-10", matures: "2029", principalMxn: 1750, rate: { en: "TIIE + 1.35 pp", es: "TIIE + 1.35 pp" }, note: { en: "Ps. 2,000 M original; Ps. 50 M quarterly repayments Apr-2023 to Apr-2024.", es: "Ps. 2,000 M originales; amortizaciones de Ps. 50 M trimestrales de abr-2023 a abr-2024." }, source: "ASUR 2Q26 Table 7" },
      { name: "BBVA loan (Cancún Airport)", type: { en: "bank loan", es: "préstamo bancario" }, issued: "2025-05-22", matures: "2027", principalMxn: 9500, rate: { en: "TIIE de fondeo + 1.25 pp", es: "TIIE de fondeo + 1.25 pp" }, note: { en: "Ps. 9,500 M; funded the 2025 dividends and liquidity.", es: "Ps. 9,500 M; financió los dividendos 2025 y liquidez." }, source: "ASUR 2Q26 Table 7" },
