...
| `market.js` | `G_MARKET` | workflow, daily | daily closes for GENTERA.MX, ^MXX, GFNORTEO.MX, RA.MX, BBAJIOO.MX, BAP; GENTERA cash dividends; USD/MXN (FRED DEXMXUS); MX 10-year (Banxico SIE `SF43936`, FRED fallback) and US 10-year (DGS10). Placeholder until the first run. |
