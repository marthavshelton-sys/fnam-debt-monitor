...
| `comments.js` (`window.ORCL_COMMENTS`) | Comments column per statement line and per operating metric, bilingual, 1Q25→1Q27, keyed `2027Q1` | `comments.json`, drafted by the routine after each release |
